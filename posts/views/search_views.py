...
from posts.serializers import PostSerializer, HashtagSerializer
...
class SearchViewSet(viewsets.ViewSet):
    ...
    def all(self, request):
        ...
        return Response({
            ...
            "meta": {
                "query": query,
                "total_results": len(posts_data) + len(users_data) + len(hashtags_data)
            }
        })
